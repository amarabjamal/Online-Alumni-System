...
function add_row(no){
    ...
    var row = table.insertRow(table_len).outerHTML="<tr id='row"+table_len+"'><td id='project_name"+table_len+"'>"+new_pro+"</td><td id='date"+table_len+"'>"+new_date+"</td><td><input type='button' id='edit_btn"+table_len+"' value='Edit' class='edit' onclick='edit_row("+table_len+")'> <input type='button' id='save_btn"+table_len+"' value='Save' class='save' onclick='save_row("+table_len+")'> <input type='button' value='Delete' class='delete' onclick='delete_row("+table_len+")'></td></tr>";
